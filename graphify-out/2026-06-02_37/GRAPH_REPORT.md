...
## Corpus Check
- 61 files · ~25,313 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 573 nodes · 675 edges · 60 communities (48 shown, 12 thin omitted)
...
Cohesion: 0.05
Nodes (41): Codable, Wiki Note to Knowledge Base LLM Pipeline, Encodable, Hashable, Identifiable, Create, Update, Create (+33 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Orto Data Model`, `Calendar UI Views`, `UI Theme & Color System`, `Settings & Theme Mode`, `Community 49`, `Community 52`, `Community 58`?**
