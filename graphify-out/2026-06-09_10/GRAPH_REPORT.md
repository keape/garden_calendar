...
## Corpus Check
- 73 files · ~35,106 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 809 nodes · 963 edges · 74 communities (61 shown, 13 thin omitted)
...
Cohesion: 0.06
Nodes (15): Plant Catalog with Activity Templates, OrtoDetailView, PiantaRowView, AggiungiPiantaView, AggiungiPiantaView.generateTemplateActivities(for:), TemplateActivity, ModificaPiantaSheet, NuovaAttivitaSheet (+7 more)
...
Cohesion: 0.08
Nodes (30): CodingKey, Rain-based Irrigation Adjustment, Decodable, CacheEntry, CodingKeys, precipitationSum, time, RainAdjuster.computeOverrides(activities:rainDays:) (+22 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `UI Theme & Color System`, `Community 7`, `Community 9`, `Community 79`, `Community 59`, `Community 63`?**
...
- **Why does `CalendarGridView` connect `Community 59` to `Community 9`, `Day Detail & Activity`, `UI Theme & Color System`, `Community 63`?**
