...
## Corpus Check
- 45 files · ~16,244 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 400 nodes · 504 edges · 39 communities (27 shown, 12 thin omitted)
...
6. `PiantaDetailView` - 12 edges
7. `QuickJournalView` - 11 edges
...
- **Why does `Attivita` connect `Community 38` to `Core Data Models`?**
