...
## Corpus Check
- 307 files · ~198,464 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3170 nodes · 3512 edges · 332 communities (265 shown, 67 thin omitted)
...
## Communities (332 total, 67 thin omitted)
...
Cohesion: 0.10
Nodes (16): CalendarGridView, ViewMode, agenda, calendar, CaseIterable, ViewMode, agenda, calendar (+8 more)
...
Cohesion: 0.05
Nodes (22): SignUpView, ContentView, SignUpView, WeatherIcon, NuovaAttivitaSheet, PiantaCardView, PiantaListView, ContentView (+14 more)
...
Cohesion: 0.15
Nodes (5): PiantaDetailView, ActivityTaskRow, AttivitaRow, JournalEventRow, PiantaDetailView
...
Cohesion: 0.15
Nodes (13): CodingKeys, precipitationSum, time, OpenMeteoClient, CacheEntry, CodingKeys, precipitationSum, temperatureMin (+5 more)
...
Cohesion: 0.12
Nodes (17): RainError, apiError, invalidURL, RepositoryError, invalidDate, RainError, apiError, invalidURL (+9 more)
...
Cohesion: 0.10
Nodes (19): Attivita, AttivitaSuggerita, PlantKnowledge, WikiNote, AttivitaSuggerita, PlantKnowledge, WikiNote, Codable (+11 more)
...
Cohesion: 0.15
Nodes (10): ActivityColorDot, AppTheme, AppTheme (ActivityColorDot local copy), WeatherIcon, Activity Color System, ActivityColorDot, AppTheme, WeatherIcon (+2 more)
...
Cohesion: 0.29
Nodes (5): CacheEntry, Date, RainAdjuster, RescheduleAction, DailyWeather
...
Cohesion: 0.12
Nodes (17): CodingKeys, createdAt, id, markdownContent, processed, slug, updatedAt, CodingKeys (+9 more)
...
## Knowledge Gaps
- **1527 isolated node(s):** `build 2.sh script`, `PostToolUse`, `PreToolUse`, `PostToolUse`, `PreToolUse` (+1522 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Community 154`, `Community 59`, `Community 9`, `Settings & Theme Mode`, `Community 175`, `Community 81`, `Community 82`, `Community 117`, `Community 89`, `Community 58`, `Community 123`, `Community 125`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `CalendarGridView` connect `Settings & Theme Mode` to `Community 49`, `Day Detail & Activity`, `Community 105`, `Community 175`?**
