...
## Corpus Check
- 64 files · ~26,518 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 591 nodes · 699 edges · 61 communities (48 shown, 13 thin omitted)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Community 7`, `Settings & Theme Mode`, `Community 49`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 49` to `Day Detail & Activity`, `Community 60`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Attivita` connect `Community 49` to `Community 52`, `Community 60`?**
