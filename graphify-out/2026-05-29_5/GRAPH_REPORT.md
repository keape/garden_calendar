...
## Corpus Check
- 45 files · ~17,016 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 397 nodes · 495 edges · 40 communities (28 shown, 12 thin omitted)
...
Cohesion: 0.06
Nodes (34): CodingKey, CodingKeys, color, createdAt, data, done, id, nome (+26 more)
...
Cohesion: 0.13
Nodes (13): ActivityColorDot, Plant Catalog with Activity Templates, OrtoDetailView, PiantaRowView, AggiungiPiantaView, AggiungiPiantaView.generateTemplateActivities(for:), TemplateActivity, ActivityTaskRow (+5 more)
...
Cohesion: 0.12
Nodes (17): Encodable, Create, Update, CodingKeys, createdAt, dataRaccoltaPrevista, dataSemina, fotoUrl (+9 more)
...
Cohesion: 0.13
Nodes (16): Codable, Wiki Note to Knowledge Base LLM Pipeline, Hashable, Identifiable, Create, Update, PiantaColtivata, PiantaColtivata.Create DTO (+8 more)
...
## Knowledge Gaps
- **151 isolated node(s):** `build.sh script`, `PostToolUse`, `PreToolUse`, `ref`, `name` (+146 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Orto Data Model`, `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Community 39`, `Authentication Views`, `Settings & Theme Mode`?**
  _High betweenness centrality (0.231) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 38` to `Day Detail & Activity`, `Core Data Models`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `Orto (Model)` connect `Day Detail & Activity` to `Community 38`?**
