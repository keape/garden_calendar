...
## Corpus Check
- 45 files · ~17,056 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 394 nodes · 487 edges · 38 communities (26 shown, 12 thin omitted)
...
Cohesion: 0.05
Nodes (41): CodingKey, CodingKeys, color, createdAt, data, done, id, nome (+33 more)
...
Cohesion: 0.06
Nodes (12): DayDetailSheet.rescheduleActivity(_:), Orto (Model), Orto.Create, Orto.Update, OrtoDetailView.deletePiante(at:), SupabaseRepository.createOrto(userId:orto:), SupabaseRepository.fetchOrti(userId:), SupabaseRepository.scheduleActivities(...) (+4 more)

### Community 3 - "UI Theme & Color System"
Cohesion: 0.09
Nodes (18): ActivityColorDot, AppTheme, Plant Catalog with Activity Templates, Hashable, OrtoDetailView, PiantaRowView, Orto, OrtoListView (+10 more)
...
Cohesion: 0.11
Nodes (22): Codable, Wiki Note to Knowledge Base LLM Pipeline, Identifiable, PiantaColtivata, PiantaColtivata.Create DTO, PiantaColtivata.Update DTO, AttivitaSuggerita, CodingKeys (+14 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Settings & Theme Mode`, `Authentication Views`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `Orto` connect `UI Theme & Color System` to `Day Detail & Activity`, `Core Data Models`, `Wiki & Knowledge Pipeline`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `Orto (Model)` connect `Day Detail & Activity` to `UI Theme & Color System`?**
