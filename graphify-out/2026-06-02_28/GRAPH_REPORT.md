...
## Corpus Check
- 55 files · ~20,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 481 nodes · 580 edges · 48 communities (36 shown, 12 thin omitted)
...
Cohesion: 0.05
Nodes (46): CodingKey, CodingKeys, color, createdAt, data, done, id, nome (+38 more)
...
Cohesion: 0.06
Nodes (32): Encodable, Create, Update, Create, Update, CodingKeys, createdAt, dataRaccoltaPrevista (+24 more)

## Knowledge Gaps
- **190 isolated node(s):** `build.sh script`, `PostToolUse`, `PreToolUse`, `ref`, `name` (+185 more)
