...
## Corpus Check
- 61 files · ~25,311 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 573 nodes · 674 edges · 61 communities (48 shown, 13 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7f788f58`
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Orto Data Model`, `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Settings & Theme Mode`, `Community 52`, `Community 58`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 38` to `Community 49`, `Day Detail & Activity`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `CodingKeys` connect `Community 49` to `Community 58`?**
