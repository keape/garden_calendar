...
## Corpus Check
- 45 files · ~16,235 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 401 nodes · 506 edges · 40 communities (27 shown, 13 thin omitted)
...
Cohesion: 0.07
Nodes (29): CodingKey, CodingKeys, createdAt, id, luogo, nome, updatedAt, userId (+21 more)

### Community 1 - "Calendar UI Views"
Cohesion: 0.06
Nodes (14): Admin Dashboard (HTML), LoginView, SignUpView, CalendarGridView, DayActivityRow, DayDetailSheet, AppTheme, AppTheme (ActivityColorDot local copy) (+6 more)
...
Cohesion: 0.11
Nodes (16): ActivityColorDot, Plant Catalog with Activity Templates, OrtoDetailView, PiantaRowView, OrtoListView, OrtoRow, AggiungiPiantaView, AggiungiPiantaView.generateTemplateActivities(for:) (+8 more)
...
Cohesion: 0.13
Nodes (17): Codable, Wiki Note to Knowledge Base LLM Pipeline, Hashable, Identifiable, Orto, Orto.Create, Orto.Update, PiantaColtivata (+9 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Orto Data Model`, `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Community 39`, `Rain & Irrigation Logic`, `Settings & Theme Mode`?**
  _High betweenness centrality (0.238) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 38` to `Authentication Views`, `Day Detail & Activity`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `Attivita` connect `Community 38` to `Authentication Views`, `Community 10`?**
