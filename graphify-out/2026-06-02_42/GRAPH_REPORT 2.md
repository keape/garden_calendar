...
## Corpus Check
- 62 files · ~26,101 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 584 nodes · 692 edges · 55 communities (42 shown, 13 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f13ec53d`
...
Cohesion: 0.07
Nodes (33): CodingKey, Rain-based Irrigation Adjustment, Decodable, CodingKeys, createdAt, id, latitudine, longitudine (+25 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Settings & Theme Mode`, `Community 49`, `Community 52`, `Community 60`?**
  _High betweenness centrality (0.167) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 49` to `Day Detail & Activity`, `Community 60`?**
