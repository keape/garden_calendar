...
## Corpus Check
- 48 files · ~16,964 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 421 nodes · 523 edges · 48 communities (36 shown, 12 thin omitted)
...
Cohesion: 0.12
Nodes (16): Encodable, Create, Update, CodingKeys, createdAt, id, latitudine, longitudine (+8 more)
...
- **Why does `Attivita` connect `Community 38` to `Community 10`, `Community 43`?**
