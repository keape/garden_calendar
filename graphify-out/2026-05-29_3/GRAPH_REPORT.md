...
## Corpus Check
- 45 files · ~16,992 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 394 nodes · 489 edges · 39 communities (27 shown, 12 thin omitted)
...
Cohesion: 0.05
Nodes (39): CodingKey, Rain-based Irrigation Adjustment, Decodable, CodingKeys, createdAt, id, luogo, nome (+31 more)
...
Cohesion: 0.06
Nodes (13): DayDetailSheet.rescheduleActivity(_:), LocalizedError, OrtoDetailView.deletePiante(at:), RainError, apiError, invalidURL, RepositoryError, invalidDate (+5 more)
...
Cohesion: 0.19
Nodes (9): Hashable, Orto (Model), Orto.Create, Orto.Update, Orto, OrtoListView, OrtoRow, SupabaseRepository.createOrto(userId:orto:) (+1 more)
...
- **Why does `Orto` connect `Community 38` to `Wiki & Knowledge Pipeline`, `Rain & Irrigation Logic`?**
