...
## Corpus Check
- 80 files · ~37,266 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 849 nodes · 1021 edges · 84 communities (70 shown, 14 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 42 edges (avg confidence: 0.83)
...
7. `PiantaDetailView` - 15 edges
8. `QuickJournalView` - 14 edges
9. `CalendarGridView` - 14 edges
...
- `PlantKnowledge` --conceptually_related_to--> `Wiki Note to Knowledge Base LLM Pipeline`  [INFERRED]
  /Users/keape/Library/Mobile Documents/com~apple~CloudDocs/app sviluppate e html/garden-calendar-ios/GardenCalendar/Models/PlantKnowledge.swift → supabase/functions/extract-plant-care/index.ts
...
Cohesion: 0.17
Nodes (12): CodingKey, CodingKeys, createdAt, data, id, note, piantaId, quantita (+4 more)
...
Cohesion: 0.05
Nodes (32): Encodable, CodingKeys, color, createdAt, data, done, id, nome (+24 more)
...
Cohesion: 0.18
Nodes (5): CalendarGridView, ViewMode, agenda, calendar, CaseIterable
...
Cohesion: 0.06
Nodes (18): ActivityColorDot, Plant Catalog with Activity Templates, OrtoDetailView, PiantaRowView, AggiungiPiantaView, AggiungiPiantaView.generateTemplateActivities(for:), TemplateActivity, ModificaPiantaSheet (+10 more)
...
Cohesion: 0.17
Nodes (7): Rain-based Irrigation Adjustment, NotificationManager, RainAdjuster.computeOverrides(activities:rainDays:), Date, OpenMeteoClient.fetchRainDays(...), OpenMeteoClient, RainAdjuster
...
Cohesion: 0.08
Nodes (20): CodingKeys, createdAt, id, latitudine, longitudine, luogo, nome, updatedAt (+12 more)
...
Cohesion: 0.07
Nodes (10): DayDetailSheet, AppTheme, AppTheme (ActivityColorDot local copy), WeatherIcon, Activity Color System, QuickJournalView, AppTheme, Color (+2 more)
...
Cohesion: 0.27
Nodes (8): Decodable, Daily, OpenMeteoClient, OpenMeteoResponse, RainError, apiError, invalidURL, RescheduleAction
...
Cohesion: 0.39
Nodes (4): CacheEntry, precipitationSum, DailyWeather, String
...
Cohesion: 0.11
Nodes (16): LocalizedError, CodingKeys, activities, color, dataSemina, growthDays, nome, offsetDays (+8 more)

### Community 92 - "Community 92"
Cohesion: 0.70
Nodes (3): Codable, AttivitaSuggerita, PlantKnowledge
...
Cohesion: 0.28
Nodes (5): Identifiable, Raccolto, WidgetActivity, WidgetActivity, WidgetDataExporter

## Knowledge Gaps
- **333 isolated node(s):** `PostToolUse`, `PreToolUse`, `allow`, `corsHeaders`, `@supabase/functions-js` (+328 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Community 9`, `Settings & Theme Mode`, `Community 81`, `Community 49`, `Community 89`, `Community 58`, `Community 63`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 58` to `Day Detail & Activity`, `Community 92`, `Community 93`, `Community 94`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `CalendarGridView` connect `Settings & Theme Mode` to `Community 49`, `Day Detail & Activity`, `Community 63`, `Community 87`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
