...
## Corpus Check
- 51 files · ~18,587 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 453 nodes · 556 edges · 50 communities (38 shown, 12 thin omitted)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Orto Data Model`, `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Community 10`, `Settings & Theme Mode`, `Community 46`?**
