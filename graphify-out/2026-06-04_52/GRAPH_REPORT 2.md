...
## Corpus Check
- 71 files · ~37,303 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 720 nodes · 831 edges · 80 communities (67 shown, 13 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `70c35061`
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 69`, `Community 9`, `Settings & Theme Mode`, `Community 78`, `Community 63`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 78` to `Day Detail & Activity`, `Community 76`, `Community 77`, `Community 79`, `Community 61`?**
