...
## Corpus Check
- 75 files · ~35,987 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 822 nodes · 981 edges · 88 communities (68 shown, 20 thin omitted)
...
Cohesion: 0.06
Nodes (18): Plant Catalog with Activity Templates, OrtoDetailView, PiantaRowView, OrtoCardRow, OrtoListView, OrtoRow, AggiungiPiantaView, AggiungiPiantaView.generateTemplateActivities(for:) (+10 more)
...
Cohesion: 0.27
Nodes (8): Encodable, Create, Orto, Orto.Create, Orto.Update, Update, SupabaseRepository.createOrto(userId:orto:), SupabaseRepository.fetchOrti(userId:)
...
Cohesion: 0.39
Nodes (5): Codable, Identifiable, AttivitaSuggerita, PlantKnowledge, Attivita
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `UI Theme & Color System`, `Community 9`, `Settings & Theme Mode`, `Community 83`, `Community 52`, `Community 54`, `Community 59`, `Community 63`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 52` to `Community 80`, `Community 82`, `Day Detail & Activity`, `Community 87`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `CalendarGridView` connect `Settings & Theme Mode` to `Community 64`, `Day Detail & Activity`, `UI Theme & Color System`, `Community 54`?**
