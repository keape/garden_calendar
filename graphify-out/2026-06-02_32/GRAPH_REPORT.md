...
## Corpus Check
- 60 files · ~22,565 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 543 nodes · 641 edges · 60 communities (48 shown, 12 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4c61e7b3`
...
Cohesion: 0.06
Nodes (31): Encodable, LocalizedError, CodingKeys, color, createdAt, data, done, id (+23 more)
...
## Knowledge Gaps
- **225 isolated node(s):** `build.sh script`, `PostToolUse`, `PreToolUse`, `ref`, `name` (+220 more)
