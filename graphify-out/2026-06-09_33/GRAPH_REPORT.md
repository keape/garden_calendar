...
## Corpus Check
- 79 files · ~36,739 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 843 nodes · 1010 edges · 95 communities (72 shown, 23 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 40 edges (avg confidence: 0.84)
...
Cohesion: 0.14
Nodes (6): Plant Catalog with Activity Templates, OrtoDetailView, PiantaRowView, AggiungiPiantaView, AggiungiPiantaView.generateTemplateActivities(for:), TemplateActivity
...
Cohesion: 0.11
Nodes (15): CodingKeys, color, createdAt, data, done, id, nome, note (+7 more)
...
Cohesion: 0.17
Nodes (5): CalendarGridView, ViewMode, agenda, calendar, DailyWeather
...
Cohesion: 0.18
Nodes (7): ActivityTaskRow, AttivitaRow, JournalEventRow, PiantaDetailView, PiantaCardView, PiantaListView, View
...
Cohesion: 0.29
Nodes (6): ActivityColorDot, AppTheme, AppTheme (ActivityColorDot local copy), Activity Color System, AppTheme, AppTheme.colorForActivity(_:)
...
Cohesion: 0.29
Nodes (7): Encodable, Identifiable, Create, Update, Raccolto, RaccoltoCreate, Attivita
...
Cohesion: 0.29
Nodes (7): CodingKey, CacheEntry, CodingKeys, precipitationSum, temperatureMin, time, String
...
Cohesion: 0.22
Nodes (7): LocalizedError, RepositoryError, invalidDate, SupabaseRepository.scheduleActivities(...), ScheduledTemplateActivity, ScheduleRequest, ScheduleResponse
...
Cohesion: 0.25
Nodes (8): CodingKeys, createdAt, data, id, note, piantaId, quantita, unita
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 9`, `Settings & Theme Mode`, `Community 80`, `Community 81`, `Community 49`, `Community 89`, `Community 58`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `CalendarGridView` connect `Settings & Theme Mode` to `Community 80`, `Community 49`, `Day Detail & Activity`, `Community 63`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 58` to `Community 88`, `Community 78`, `Day Detail & Activity`, `Community 94`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
