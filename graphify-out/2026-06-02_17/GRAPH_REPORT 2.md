...
## Corpus Check
- 51 files · ~18,526 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 451 nodes · 554 edges · 50 communities (37 shown, 13 thin omitted)
...
8. `PiantaDetailView` - 12 edges
9. `CodingKeys` - 11 edges
...
Cohesion: 0.07
Nodes (13): Admin Dashboard (HTML), LoginView, SignUpView, DayActivityRow, DayDetailSheet, AppTheme, AppTheme (ActivityColorDot local copy), WeatherIcon (+5 more)
...
Cohesion: 0.21
Nodes (7): Decodable, CacheEntry, precipitationSum, Daily, Date, OpenMeteoClient, OpenMeteoResponse
...
Cohesion: 0.07
Nodes (28): Encodable, Create, Update, CodingKeys, createdAt, id, latitudine, longitudine (+20 more)
...
Cohesion: 0.29
Nodes (6): CodingKey, CodingKeys, time, SupabaseRepository.scheduleActivities(...), ScheduleRequest, String
...
## Knowledge Gaps
- **174 isolated node(s):** `build.sh script`, `PostToolUse`, `PreToolUse`, `ref`, `name` (+169 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Authentication Views`, `Community 10`, `Settings & Theme Mode`, `Community 46`?**
  _High betweenness centrality (0.195) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 38` to `Day Detail & Activity`, `Community 43`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Attivita` connect `Community 38` to `Community 43`, `Wiki & Knowledge Pipeline`?**
