...
## Corpus Check
- 65 files · ~26,964 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 598 nodes · 707 edges · 61 communities (47 shown, 14 thin omitted)
...
Cohesion: 0.06
Nodes (30): Codable, Wiki Note to Knowledge Base LLM Pipeline, Hashable, Identifiable, Orto, Orto.Create, Orto.Update, ActivityOverride (+22 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Community 9`, `Settings & Theme Mode`, `Community 49`?**
  _High betweenness centrality (0.158) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 49` to `Day Detail & Activity`, `Community 7`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Attivita` connect `Community 49` to `Community 7`?**
