...
## Corpus Check
- 62 files · ~25,184 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 572 nodes · 673 edges · 59 communities (47 shown, 12 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8d185d0d`
...
Cohesion: 0.09
Nodes (22): Codable, Wiki Note to Knowledge Base LLM Pipeline, Hashable, Identifiable, Orto, Orto.Create, Orto.Update, ActivityOverride (+14 more)
...
Cohesion: 0.07
Nodes (28): Encodable, CodingKeys, color, createdAt, data, done, id, nome (+20 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Orto Data Model`, `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Settings & Theme Mode`, `Community 58`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 38` to `Day Detail & Activity`, `Community 60`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `CodingKeys` connect `Community 49` to `Community 58`, `Community 38`?**
