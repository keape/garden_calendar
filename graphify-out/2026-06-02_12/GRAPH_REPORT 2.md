...
## Corpus Check
- 49 files · ~17,289 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 431 nodes · 533 edges · 48 communities (35 shown, 13 thin omitted)
...
Cohesion: 0.27
Nodes (7): Encodable, Create, Update, Create, Update, Create, Update
...
Cohesion: 0.17
Nodes (11): CodingKeys, activities, color, dataSemina, growthDays, nome, offsetDays, piantaId (+3 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Community 41`, `Community 44`, `Settings & Theme Mode`, `Community 46`?**
  _High betweenness centrality (0.211) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 38` to `Community 10`, `Day Detail & Activity`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `Attivita` connect `Community 38` to `Community 10`, `Wiki & Knowledge Pipeline`?**
