...
## Corpus Check
- 48 files · ~16,895 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 419 nodes · 521 edges · 43 communities (31 shown, 12 thin omitted)
...
## Knowledge Gaps
- **162 isolated node(s):** `build.sh script`, `PostToolUse`, `PreToolUse`, `ref`, `name` (+157 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Orto Data Model`, `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Wiki & Knowledge Pipeline`, `Community 41`, `Settings & Theme Mode`?**
