...
## Corpus Check
- 45 files · ~16,994 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 394 nodes · 490 edges · 39 communities (27 shown, 12 thin omitted)
...
Cohesion: 0.07
Nodes (7): DayDetailSheet.rescheduleActivity(_:), OrtoDetailView.deletePiante(at:), SupabaseRepository.scheduleActivities(...), ScheduledTemplateActivity, ScheduleRequest, ScheduleResponse, SupabaseRepository
...
Cohesion: 0.08
Nodes (23): Codable, Wiki Note to Knowledge Base LLM Pipeline, Hashable, Identifiable, PiantaColtivata, PiantaColtivata.Create DTO, PiantaColtivata.Update DTO, AttivitaSuggerita (+15 more)
...
Cohesion: 0.21
Nodes (8): Orto (Model), Orto.Create, Orto.Update, Orto, OrtoListView, OrtoRow, SupabaseRepository.createOrto(userId:orto:), SupabaseRepository.fetchOrti(userId:)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Authentication Views`, `Settings & Theme Mode`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 38` to `Schedule Activities Function`, `Core Data Models`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `Orto (Model)` connect `Community 38` to `Day Detail & Activity`?**
