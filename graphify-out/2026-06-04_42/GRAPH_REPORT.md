...
## Corpus Check
- 71 files · ~37,213 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 718 nodes · 828 edges · 84 communities (63 shown, 21 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92684fc3`
...
7. `CalendarGridView` - 13 edges
8. `PiantaDetailView` - 13 edges
9. `DayDetailSheet` - 13 edges
10. `QuickJournalView` - 12 edges
...
Cohesion: 0.05
Nodes (38): Codable, Wiki Note to Knowledge Base LLM Pipeline, Hashable, Identifiable, Orto, Orto.Create, Orto.Update, ActivityOverride (+30 more)
...
Cohesion: 0.05
Nodes (38): Encodable, LocalizedError, CodingKeys, color, createdAt, data, done, id (+30 more)
...
Cohesion: 0.33
Nodes (5): Decodable, Daily, OpenMeteoClient, OpenMeteoResponse, RescheduleAction
...
Cohesion: 0.29
Nodes (3): Rain-based Irrigation Adjustment, Date, RainAdjuster
...
Cohesion: 0.29
Nodes (6): CodingKey, CacheEntry, CodingKeys, precipitationSum, time, String
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Community 64`, `Community 65`, `Calendar UI Views`, `UI Theme & Color System`, `Community 7`, `Community 9`, `Settings & Theme Mode`, `Community 77`, `Community 58`, `Community 63`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 7` to `Community 9`, `Day Detail & Activity`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `CalendarGridView` connect `Settings & Theme Mode` to `Day Detail & Activity`, `UI Theme & Color System`, `Community 76`, `Community 63`?**
