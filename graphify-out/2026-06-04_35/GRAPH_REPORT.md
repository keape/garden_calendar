...
## Corpus Check
- 70 files · ~36,730 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 701 nodes · 807 edges · 75 communities (62 shown, 13 thin omitted)
...
Cohesion: 0.05
Nodes (41): Codable, Wiki Note to Knowledge Base LLM Pipeline, Encodable, Hashable, Identifiable, CodingKeys, color, createdAt (+33 more)
