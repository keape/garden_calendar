...
## Corpus Check
- 50 files · ~18,312 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 445 nodes · 549 edges · 50 communities (38 shown, 12 thin omitted)
...
## Knowledge Gaps
- **170 isolated node(s):** `build.sh script`, `PostToolUse`, `PreToolUse`, `ref`, `name` (+165 more)
