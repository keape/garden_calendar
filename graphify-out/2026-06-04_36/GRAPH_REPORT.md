...
## Corpus Check
- 70 files · ~36,789 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 702 nodes · 808 edges · 75 communities (62 shown, 13 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `80183f2f`
...
8. `CalendarGridView` - 13 edges
9. `PiantaDetailView` - 13 edges
...
Cohesion: 0.07
Nodes (11): DayActivityRow, DayDetailSheet, AppTheme, AppTheme (ActivityColorDot local copy), WeatherIcon, Activity Color System, QuickJournalView, AppTheme (+3 more)
...
Cohesion: 0.07
Nodes (16): ActivityColorDot, Plant Catalog with Activity Templates, OrtoDetailView, PiantaRowView, AggiungiPiantaView, AggiungiPiantaView.generateTemplateActivities(for:), TemplateActivity, ModificaPiantaSheet (+8 more)
...
Cohesion: 0.06
Nodes (32): Codable, Wiki Note to Knowledge Base LLM Pipeline, Hashable, Identifiable, Orto, Orto.Create, Orto.Update, ActivityOverride (+24 more)
...
Cohesion: 0.09
Nodes (23): Encodable, Create, Update, Create, Update, CodingKeys, activityOverrides, createdAt (+15 more)
...
## Knowledge Gaps
- **318 isolated node(s):** `build.sh script`, `PostToolUse`, `PreToolUse`, `ref`, `name` (+313 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Community 65`, `Calendar UI Views`, `UI Theme & Color System`, `Community 7`, `Community 9`, `Settings & Theme Mode`, `Community 49`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 7` to `Day Detail & Activity`, `Community 59`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `CalendarGridView` connect `Settings & Theme Mode` to `Calendar UI Views`, `Day Detail & Activity`, `UI Theme & Color System`?**
