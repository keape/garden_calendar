...
## Corpus Check
- 73 files · ~35,111 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 810 nodes · 964 edges · 82 communities (61 shown, 21 thin omitted)
...
Cohesion: 0.05
Nodes (38): Codable, Wiki Note to Knowledge Base LLM Pipeline, Identifiable, AttivitaSuggerita, CodingKeys, attivitaSuggerite, color, createdAt (+30 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (24): Encodable, LocalizedError, CodingKeys, color, createdAt, data, done, id (+16 more)
...
Cohesion: 0.06
Nodes (35): CalendarGridView, ViewMode, agenda, calendar, CodingKey, Rain-based Irrigation Adjustment, Decodable, CacheEntry (+27 more)
...
Cohesion: 0.28
Nodes (5): AppTheme, AppTheme (ActivityColorDot local copy), Activity Color System, AppTheme, AppTheme.colorForActivity(_:)
...
## Knowledge Gaps
- **326 isolated node(s):** `PostToolUse`, `PreToolUse`, `corsHeaders`, `@supabase/functions-js`, `@supabase/supabase-js` (+321 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `UI Theme & Color System`, `Community 7`, `Community 9`, `Settings & Theme Mode`, `Community 79`, `Community 80`, `Community 49`, `Community 54`, `Community 59`, `Community 63`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 79` to `Community 58`, `Day Detail & Activity`, `Wiki & Knowledge Pipeline`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `CalendarGridView` connect `Settings & Theme Mode` to `Community 64`, `Community 49`, `Day Detail & Activity`, `Community 54`?**
