...
## Corpus Check
- 71 files · ~37,234 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 719 nodes · 829 edges · 77 communities (64 shown, 13 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6494e7e6`
...
Cohesion: 0.06
Nodes (18): ActivityColorDot, Plant Catalog with Activity Templates, OrtoDetailView, PiantaRowView, OrtoListView, OrtoRow, AggiungiPiantaView, AggiungiPiantaView.generateTemplateActivities(for:) (+10 more)
