...
## Corpus Check
- 70 files · ~36,631 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 698 nodes · 804 edges · 77 communities (64 shown, 13 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a4fb78d3`
...
Cohesion: 0.07
Nodes (29): Encodable, LocalizedError, CodingKeys, color, createdAt, data, done, id (+21 more)
...
Cohesion: 0.25
Nodes (3): Orto, OrtoListView, OrtoRow
...
Cohesion: 0.43
Nodes (4): Rain-based Irrigation Adjustment, Date, RainAdjuster, String
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 69`, `Community 7`, `Settings & Theme Mode`, `Community 49`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 69` to `Community 65`, `Day Detail & Activity`, `Community 7`, `Community 9`, `Community 49`?**
