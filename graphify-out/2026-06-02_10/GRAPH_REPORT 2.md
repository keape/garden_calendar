...
## Corpus Check
- 49 files · ~17,094 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 429 nodes · 531 edges · 47 communities (35 shown, 12 thin omitted)
...
Cohesion: 0.06
Nodes (31): Codable, Wiki Note to Knowledge Base LLM Pipeline, Hashable, Identifiable, Orto, Orto.Create, Orto.Update, PiantaColtivata (+23 more)
...
## Knowledge Gaps
- **164 isolated node(s):** `build.sh script`, `PostToolUse`, `PreToolUse`, `ref`, `name` (+159 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Wiki & Knowledge Pipeline`, `Community 41`, `Settings & Theme Mode`, `Community 46`?**
  _High betweenness centrality (0.210) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 38` to `Day Detail & Activity`, `Community 43`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `Attivita` connect `Community 38` to `Community 43`?**
