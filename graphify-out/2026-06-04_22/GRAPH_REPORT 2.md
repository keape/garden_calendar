...
## Corpus Check
- 66 files · ~27,348 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 601 nodes · 710 edges · 59 communities (46 shown, 13 thin omitted)
...
## Knowledge Gaps
- **249 isolated node(s):** `build.sh script`, `PostToolUse`, `PreToolUse`, `ref`, `name` (+244 more)
