...
## Corpus Check
- 63 files · ~26,266 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 585 nodes · 693 edges · 60 communities (47 shown, 13 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e0b6247`
...
Cohesion: 0.05
Nodes (37): Encodable, CodingKeys, color, createdAt, data, done, id, nome (+29 more)
