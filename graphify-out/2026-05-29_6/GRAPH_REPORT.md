...
## Corpus Check
- 45 files · ~16,929 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 398 nodes · 500 edges · 40 communities (28 shown, 12 thin omitted)
...
Cohesion: 0.09
Nodes (26): Codable, Wiki Note to Knowledge Base LLM Pipeline, Encodable, Hashable, Identifiable, Create, Update, Create (+18 more)
...
- **Why does `Orto` connect `Community 38` to `Day Detail & Activity`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `CodingKeys` connect `Core Data Models` to `Orto Data Model`, `Community 38`?**
