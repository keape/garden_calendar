...
## Corpus Check
- 74 files · ~35,490 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 816 nodes · 974 edges · 87 communities (69 shown, 18 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.84)
...
Cohesion: 0.10
Nodes (6): OrtoDetailView, PiantaRowView, Orto, OrtoCardRow, OrtoListView, OrtoRow
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `UI Theme & Color System`, `Community 9`, `Settings & Theme Mode`, `Community 80`, `Community 49`, `Community 83`, `Community 54`, `Community 86`, `Community 58`, `Community 59`, `Community 63`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 58` to `Day Detail & Activity`, `UI Theme & Color System`, `Wiki & Knowledge Pipeline`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `CalendarGridView` connect `Settings & Theme Mode` to `Community 80`, `Day Detail & Activity`, `Community 64`, `Community 54`?**
