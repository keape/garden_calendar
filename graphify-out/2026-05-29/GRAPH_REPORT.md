...
## Summary
- 365 nodes · 461 edges · 36 communities (25 shown, 11 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.85)
...
- [[_COMMUNITY_Schedule Activities Function|Schedule Activities Function]]
...
1. `SupabaseRepository` - 37 edges
2. `CodingKeys` - 16 edges
3. `CodingKeys` - 14 edges
4. `CodingKeys` - 14 edges
5. `AppTheme` - 13 edges
6. `QuickJournalView` - 11 edges
7. `PiantaDetailView` - 11 edges
...
Cohesion: 0.07
Nodes (32): CodingKey, CodingKeys, createdAt, id, luogo, nome, updatedAt, userId (+24 more)

### Community 1 - "Calendar UI Views"
Cohesion: 0.09
Nodes (10): CalendarGridView, DayActivityRow, DayDetailSheet, AppTheme (ActivityColorDot local copy), WeatherIcon, Activity Color System, QuickJournalView, AppTheme (+2 more)

### Community 2 - "Day Detail & Activity"
Cohesion: 0.07
Nodes (8): DayDetailSheet.rescheduleActivity(_:), Orto (Model), Orto.Create, Orto.Update, OrtoDetailView.deletePiante(at:), SupabaseRepository.createOrto(userId:orto:), SupabaseRepository.fetchOrti(userId:), SupabaseRepository

### Community 3 - "UI Theme & Color System"
Cohesion: 0.11
Nodes (14): ActivityColorDot, AppTheme, Plant Catalog with Activity Templates, OrtoDetailView, PiantaRowView, AggiungiPiantaView, AggiungiPiantaView.generateTemplateActivities(for:), TemplateActivity (+6 more)
...
Cohesion: 0.10
Nodes (19): Encodable, Create, Update, Create, Update, CodingKeys, createdAt, dataRaccoltaPrevista (+11 more)

### Community 6 - "Wiki & Knowledge Pipeline"
Cohesion: 0.15
Nodes (14): Codable, Wiki Note to Knowledge Base LLM Pipeline, Hashable, Identifiable, PiantaColtivata, PiantaColtivata.Create DTO, PiantaColtivata.Update DTO, AttivitaSuggerita (+6 more)

### Community 7 - "Rain & Irrigation Logic"
Cohesion: 0.13
Nodes (12): Rain-based Irrigation Adjustment, Decodable, CacheEntry, precipitationSum, RainAdjuster.computeOverrides(activities:rainDays:), Daily, Date, OpenMeteoClient.fetchRainDays(...) (+4 more)

### Community 8 - "Repository & Error Handling"
Cohesion: 0.11
Nodes (17): LocalizedError, RainError, apiError, invalidURL, CodingKeys, activities, color, dataSemina (+9 more)

### Community 9 - "Authentication Views"
Cohesion: 0.12
Nodes (4): Admin Dashboard (HTML), LoginView, SignUpView, AuthManager

### Community 10 - "Schedule Activities Function"
Cohesion: 0.12
...
## Knowledge Gaps
- **132 isolated node(s):** `build.sh script`, `ref`, `name`, `organization_id`, `organization_slug` (+127 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Orto Data Model`, `Calendar UI Views`, `UI Theme & Color System`, `Wiki & Knowledge Pipeline`, `Repository & Error Handling`, `Authentication Views`, `Settings & Theme Mode`?**
  _High betweenness centrality (0.259) - this node is a cross-community bridge._
- **Why does `Orto` connect `Wiki & Knowledge Pipeline` to `Day Detail & Activity`, `Core Data Models`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `Orto (Model)` connect `Day Detail & Activity` to `Wiki & Knowledge Pipeline`?**
...
- **What connects `build.sh script`, `ref`, `name` to the rest of the system?**
