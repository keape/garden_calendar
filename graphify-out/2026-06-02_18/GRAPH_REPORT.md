...
## Corpus Check
- 51 files · ~18,551 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 452 nodes · 555 edges · 45 communities (33 shown, 12 thin omitted)
...
Cohesion: 0.05
Nodes (44): CodingKey, CodingKeys, createdAt, id, latitudine, longitudine, luogo, nome (+36 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Orto Data Model`, `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Community 10`, `Settings & Theme Mode`?**
