...
## Corpus Check
- 76 files · ~36,315 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 826 nodes · 989 edges · 78 communities (61 shown, 17 thin omitted)
...
Cohesion: 0.06
Nodes (36): CodingKey, CodingKeys, activityOverrides, createdAt, dataRaccoltaPrevista, dataSemina, fotoUrl, growthDays (+28 more)
...
Cohesion: 0.05
Nodes (17): Admin Dashboard (HTML), LoginView, SignUpView, ActivityColorDot, AppTheme, AppTheme (ActivityColorDot local copy), Activity Color System, AuthManager (+9 more)
...
Cohesion: 0.05
Nodes (42): CalendarGridView, ViewMode, agenda, calendar, CaseIterable, Rain-based Irrigation Adjustment, Decodable, LocalizedError (+34 more)
...
Cohesion: 0.06
Nodes (36): Codable, Wiki Note to Knowledge Base LLM Pipeline, Encodable, Hashable, Identifiable, Create, Update, CodingKeys (+28 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 9`, `Settings & Theme Mode`, `Community 49`, `Community 52`, `Community 87`, `Community 58`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 58` to `Day Detail & Activity`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `CalendarGridView` connect `Settings & Theme Mode` to `Community 9`, `Day Detail & Activity`, `Calendar UI Views`, `Community 87`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
