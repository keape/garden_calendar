...
## Corpus Check
- 63 files · ~26,329 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 585 nodes · 694 edges · 61 communities (48 shown, 13 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `262fde3d`
...
7. `PiantaDetailView` - 13 edges
8. `QuickJournalView` - 12 edges
9. `DayDetailSheet` - 12 edges
...
Cohesion: 0.06
Nodes (27): Codable, Wiki Note to Knowledge Base LLM Pipeline, Identifiable, Orto, Orto.Create, Orto.Update, AttivitaSuggerita, PlantKnowledge (+19 more)
...
- **Why does `SupabaseRepository` connect `Day Detail & Activity` to `Calendar UI Views`, `UI Theme & Color System`, `Community 38`, `Community 7`, `Settings & Theme Mode`, `Community 49`, `Community 52`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `Orto` connect `Community 49` to `Day Detail & Activity`, `Community 59`, `Community 60`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Attivita` connect `Community 49` to `Community 60`?**
